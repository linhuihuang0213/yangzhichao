...
//*************************************网站设置****************************************
    ...
    'ADMIN_EMAIL'               =>  'yangzhichao@yangzhichao.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '杨志超博客',             //网站名：
    'WEB_KEYWORDS'              =>  '杨志超,帅白,技术博客,个人博客,bjyblog',         //网站关键字
    'WEB_DESCRIPTION'           =>  '杨志超的个人技术博客,bjyblog官方网站',      //网站描述
    'AUTHOR'                    =>  '杨志超',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为杨志超原创文章,转载无需和我联系,但请注明来自杨志超博客yangzhichao.com',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '杨志超博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'yangzhichao.com',      //文字水印内容
